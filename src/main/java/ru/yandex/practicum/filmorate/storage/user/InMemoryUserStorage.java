...
public class InMemoryUserStorage implements UserStorage {
    ...
    public User addUser(User user) {
        ...
        log.info("A request to add a user has been received. The user has been added.");
        return user;
    }
    ...
    public User updateUser(User user) {
        if (users.containsKey(user.getId())) {
            ...
            log.error("A request to modify the user has been received. The user was not found.");
